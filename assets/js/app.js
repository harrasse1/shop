...
(function () {
  ...
  function productCard(p) {
    ...
    const imageContent = p.image
      ? `<img src="${p.image}" alt="${p.name}" loading="lazy" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';" /><div class="product__img-fallback" style="display:none;"><i class="fas ${p.icon}"></i></div>`
